...
char puzzle[size][size]={{0}}; /* double array of all the letters of the word search */
char words[100/*max words = 100 */][size]={{0}}; /* double array to contain all the words to be found in the puzzle */
char printpuzzle[size][size]={{0}}; /* double array that will contain the solved word search for the final output */
    ...
    for(r=0;r<size;r++){ /*goes through rows of matrix*/
        for(c=0;c<size;c++){ /*goes through columns of matrix*/
            if (*(word)==puzzle[r][c]) {/*found first letter*/
                ...
                */ 
                if(*(word+1)==puzzle[r-1][c]||wordfound!=true){   
                    direction=1;
                ...
                if(*(word+1)==puzzle[r-1][c+1]||wordfound!=true){
                    direction=2;
                    if(checkRestofWord(word,r,c,ws,direction)){
                        wordfound=true;
                        r=size;
                ...
                if(*(word+1)==puzzle[r][c+1]||wordfound!=true){
                    direction=3;
                    if(checkRestofWord(word,r,c,ws,direction)){
                        wordfound=true;
                        r=size;
