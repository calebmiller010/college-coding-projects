/*
    Name        : Caleb Miller
    Class       : 3320-002
    Program #   : Assignment 2, Problem 2a
...
Description: This program practices the use of the bucket sort, using an array
             ...
             out what it looks like after each pass
*/
...
public class BucketSort {
        ...
        BucketSort[] list = new BucketSort[10];
    
    public static void main (String args[]) {
        
        //get input from user
        Scanner sc = new Scanner(System.in);
        BucketSort ins = new BucketSort();
...
//                    increases the size at that array
    ...
    public void sort ( int[] intArray, int modifier ) {
        for (int x=0; x < intArray.length; x++) {
            int y = ((intArray[x] % modifier)/(modifier/10));
